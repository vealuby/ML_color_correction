...
async def correction(
        img,
        shadow_amount_percent = 0.3, shadow_tone_percent = 0.3, shadow_radius = 20,
        highlight_amount_percent = 0.9, highlight_tone_percent = 0.5, highlight_radius = 100,
        color_percent = 0
):
    """
    Image Shadow / Highlight Correction. The same function as it in Photoshop / GIMP 
    :param img: input RGB image numpy array of shape (height, width, 3) cv2.imread(path)
